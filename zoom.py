...
class AutoScrollbar(ttk.Scrollbar):
    ...
    def pack(self, **kw):
        raise tkin.TclError('Cannot use pack with the widget ' + self.__class__.__name__)

    def place(self, **kw):
        raise tkin.TclError('Cannot use place with the widget ' + self.__class__.__name__)
...
class CanvasImage:
    ...
    def __init__(self, placeholder, path):
        ...
        self.canvas = tkin.Canvas(self.__imframe, highlightthickness=0,
                                xscrollcommand=hbar.set, yscrollcommand=vbar.set)
        self.canvas.grid(row=0, column=0, sticky='nswe', columnspan=2)
        self.canvas.update()  # wait till canvas is created

        f = tkin.Button(self.__imframe, text="Zoom out", command=self.Zoom2, height=4, width=50, bg='#54FA9B' )
...
class MainWindow(ttk.Frame):
    ...
    def __init__(self, mainframe, path):
        ...
        self.master.title('Grapic project')
        #make logo for Tkinter Frame
        self.master.iconbitmap('magic copy.ico')

        self.master.geometry('500x500+10+10')  # size of the main window
...
app = MainWindow(tkin.Tk(), path="657479-500x500.jpg")
